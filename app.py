...
st.markdown("<h1 style='text-align: center;'>🦠SIL Covid-19 Data and Statistics Visualization Dashboard💉😷</h1>", unsafe_allow_html=True)
...
st.image('CoronavirusGlobalTelecon-1024x512.jpg')
...
st.title('Made by Yomin Rajapakshe of team SIL of Meulabs')